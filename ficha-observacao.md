...
**Escopo do problema do Instituto Mão Amiga que este projeto resolve:**
...
Vou construir um aplicativo mobile que inicialmente mostrará uma lista dos
...
- [x] Repositório criado na conta pessoal do GitHub
- [x] README mínimo criado
- [x] Primeiro commit realizado com o Hello World do Expo rodando
